...
class SimilarProducts(models.TransientModel):
    ...
    product_template_id = fields.Many2one('product.template', index=True, required=True, ondelete='cascade')
    product_product_id = fields.Many2one('product.product', index=True, required=True, ondelete='cascade')
